...
var client_id = "e390fae3bd4346c5b454854c17ba9f6d"; // Your client id
var client_secret = "3d41f298db894b4bba46699f6e59af52"; // Your secret
...
app.get("/get_lyrics", async (req, res) => {
  var artist = req.query.artist || null;
  var song_name = req.query.name || null;
